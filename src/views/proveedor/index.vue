<template>
      ...
      <div v-if="$store.state.user.tipo_usuario == 1 || $store.state.user.tipo_usuario == 3 || $store.state.user.tipo_usuario == 4 || $store.state.user.tipo_usuario == 5 || $store.state.user.tipo_usuario == 6">
        ...
        <div class="contenedor-tabla">
          ...
          >
            ...
            <!-- Razon social -->
            <el-table-column label="Razón social" prop="razonsocial">
              <template #default="props">
            ...
            <!-- Codigo -->
            <el-table-column label="Código" prop="codigo" width="200px">
              <template #default="props">
            ...
            <!-- CUIT -->
            <el-table-column label="CUIT" prop="cuit" width="300px">
              <template #default="props">
          ...
          >
            ...
            <!-- Activo -->
            <el-table-column label="Activo" prop="activo" width="100px">
              <template #default="props">
            ...
            >
              <template #default="props">
                <el-button
                  ...
                  v-if="$store.state.user.tipo_usuario == 1 || $store.state.user.tipo_usuario == 3 || $store.state.user.tipo_usuario == 4"
                >
            ...
            >
              <template #default="props">
                <el-button
                  ...
                  v-if="$store.state.user.tipo_usuario == 1 || $store.state.user.tipo_usuario == 3 || $store.state.user.tipo_usuario == 4 || $store.state.user.tipo_usuario == 5 || $store.state.user.tipo_usuario == 6"
                >
  ...
  <modal-rubro ref="modalRubro"></modal-rubro>
</template>

...
export default {
	name: 'ModalPresupuestacionNuevo',
	...
	methods: {
		...
		async cantidadMeses() {
			...
			let params = { arrayBuscarProductosEnPrevision: JSON.stringify(this.arrayBuscarProductosEnPrevision) };
		...
		>
			...
			>
				...
				>
					...
					<el-form-item
						label="Período de abastecimiento"
						style="width:100%;"
					>
						<el-row
							:gutter="10"

...
export declare const getPanel: (type: IDatePickerType) => import("vue").DefineComponent<{
    ...
    formatEmit: (emitDayjs: dayjs.Dayjs | null, index?: number | undefined) => dayjs.Dayjs | undefined;
    handleRangePick: (val: {
        minDate: dayjs.Dayjs;
    ...
    handleMinTimePick: (value: dayjs.Dayjs, visible: boolean, first: boolean) => void;
    handleMaxTimePick: (value: dayjs.Dayjs | null, visible: boolean, first: boolean) => void;
    handleClear: () => void;
    formatToString: (value: dayjs.Dayjs | dayjs.Dayjs[]) => string | string[];
    parseUserInput: (value: dayjs.Dayjs | dayjs.Dayjs[]) => dayjs.Dayjs | dayjs.Dayjs[];
    onParsedValueChanged: (minDate: dayjs.Dayjs | undefined, maxDate: dayjs.Dayjs | undefined) => void;
    ...
    formatToString: (days: dayjs.Dayjs[]) => string[];
    onParsedValueChanged: (minDate: dayjs.Dayjs | undefined, maxDate: dayjs.Dayjs | undefined) => void;
    ElIcon: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
        readonly size: {
            readonly type: import("vue").PropType<import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => (string | number) & {}) | (() => string | number) | ((new (...args: any[]) => (string | number) & {}) | (() => string | number))[], unknown, unknown>>;
    ...
    timeWithinRange: (_: string | number | Date | dayjs.Dayjs | null | undefined, __: any, ___: string) => boolean;
    props: Readonly<import("@vue/shared").LooseRequired<Readonly<import("vue").ExtractPropTypes<{
        readonly parsedValue: {
            readonly type: import("vue").PropType<import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => dayjs.Dayjs | dayjs.Dayjs[]) | (() => dayjs.Dayjs | dayjs.Dayjs[]) | ((new (...args: any[]) => dayjs.Dayjs | dayjs.Dayjs[]) | (() => dayjs.Dayjs | dayjs.Dayjs[]))[], unknown, unknown>>;
            readonly required: false;
    ...
    checkDateWithinRange: (date: string | number | Date | dayjs.Dayjs | null | undefined) => boolean;
    formatEmit: (emitDayjs: dayjs.Dayjs) => dayjs.Dayjs;
    emit: (value: dayjs.Dayjs | dayjs.Dayjs[], ...args: any[]) => void;
